This repo is a demo based on Cosmos-SDK, the name service is a service to allow user could buy/sell/set names like DNS, all the
 transactions will be recorded on the Cosmos application blockchain.
